...
public class ProfesoresController : ControllerBase
{
    ...
    public async Task<ActionResult<PagedResult<ProfesorDto>>> GetDeleted([FromQuery] AudiSoft.School.Application.Common.QueryParams queryParams)
    {
        _logger.LogInformation("Obteniendo profesores eliminados para auditoría");
